...
class Place(BaseModel):
    """
    Place class represents a place or accommodation in the AirBnB application.
    ...
    Attributes:
        ...
        amenity_ids (str): A string representation of amenity IDs associated with the place.
    """
